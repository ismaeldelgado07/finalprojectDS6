...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean Registrar(String cedula, String nombre, String celular, String contrasena) {
        ...
        contentValues.put(COL_USERNAME, cedula);
    ...
    public String obtenerNombre(String pass) {
        ...
        String query = "SELECT " + COL_USERNAME + " FROM " + TABLE_NAME + " WHERE " +
    ...
    public boolean ActualizarDatos(String cedula, String contrasena, String nombre, String celular) {
        ...
        int result = db.update(TABLE_NAME, contentValues, whereClause, whereArgs); //Devuelve un número entero con la cantidad de filas afectadas
        return result > 0;
    }
    ...
    public boolean BorrarDatos(String cedula, String contrasena) {
        ...
        String[] whereArgs = {cedula, contrasena};  //argumentos de la condición
        int result = db.delete(TABLE_NAME, whereClause, whereArgs); //Devuelve un número entero con la cantidad de filas afectadas
        return result > 0;
    }
